public class GUIToUser extends javax.swing.JFrame {
    ...
    //warum das durchgestrichen? Evtl weil bei default nix selected?
    public String[] getlstSelectedUseres(){
        String[] sSelectedUsers;
        sSelectedUsers = (String[]) lstSelectedUseres.getSelectedValues();
        return sSelectedUsers;
    }
    
    public int getSelectedUserIndex(){
        int iSelectedUserIndex = lstSelectedUseres.getSelectedIndex();
        return iSelectedUserIndex;
    }
